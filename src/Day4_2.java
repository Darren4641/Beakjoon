public class Day4_2 {
    ...
    public static void main(String[] args) {
        String[] wallpaper = {".#...", "..#..", "...#."};
        System.out.println(new Day4_2().solution(wallpaper)[0]);
        System.out.println(new Day4_2().solution(wallpaper)[1]);
        System.out.println(new Day4_2().solution(wallpaper)[2]);
        System.out.println(new Day4_2().solution(wallpaper)[3]);
    }
}
